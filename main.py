...
def get_financial_statements(ticker):
    ...
    balance_sheet = balance_sheet_data.to_string() if hasattr(balance_sheet_data, 'to_string') else str(
        balance_sheet_data)
    ...
    income_statement = income_statement_data.to_string() if hasattr(income_statement_data, 'to_string') else str(
